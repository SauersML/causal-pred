...
We obtain response-scale standard errors for the predicted survival probabilities using \texttt{gamfit}'s survival uncertainty interface. These standard errors represent uncertainty within a fitted survival model.
