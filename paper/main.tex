...
Our edge-inclusion prior is informed by published Mendelian-randomisation evidence (e.g.\ \citealt{Fall2015, Xue2018, Ference2017}). Where no published IVW estimate is available, the prior is left non-informative and not imputed, so the structural posterior is never biased by unattributed prior claims \citep{DaveySmith2014}.
