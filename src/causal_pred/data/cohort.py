...
# Curated panel of common, clinically meaningful OMOP condition concepts used
# to bound the BigQuery `condition_occurrence` pull and the resulting
# crosscoder phenome stream. Single source of truth: the (name, id) catalog
# below. Extend this catalog (rather than relaxing the
...
CURATED_OMOP_CONDITION_CATALOG: Tuple[Tuple[str, int], ...] = (
    ...
    ("Peripheral neuritis", 4027396),
    ("Gastrointestinal hemorrhage", 192671),
    ...
    ("Gastritis", 201340),
    ("Conjunctivitis", 379019),
    ("Kidney stone", 201620),
    ("Sepsis", 132797),
    ("Respiratory failure", 4256228),
    ("Low blood pressure", 317002),
    ("Glaucoma", 437541),
    ("Thrombocytopenic disorder", 432870),
    ("Esophagitis", 30753),
    ("Angina pectoris", 321318),
    ("Venous thrombosis", 444247),
    ("Cranial nerve disorder", 441848),
    ("Hyperkalemia", 434610),
    ("Human papilloma virus infection", 441788),
    ("Acute respiratory failure", 319049),
    ("Degeneration of retina", 4318985),
    ("Psychotic disorder", 436073),
    ("Gout", 440674),
    ("Otitis media", 372328),
    ("Cerebral infarction", 443454),
    ("Epilepsy", 380378),
    ("Leukopenia", 435224),
    ("Malignant tumor of breast", 4112853),
    ("Human immunodeficiency virus infection", 439727),
    ("Rheumatoid arthritis", 80809),
    ("Acute myocardial infarction", 312327),
    ("Seborrheic dermatitis", 137053),
    ("Retinopathy due to diabetes mellitus", 4174977),
    ("Pulmonary embolism", 440417),
    ("Malignant tumor of prostate", 4163261),
    ("Opioid dependence", 438120),
    ("Herpes simplex", 444429),
    ("Deep venous thrombosis", 4133004),
    ("End-stage renal disease", 193782),
    ("Attention deficit hyperactivity disorder", 438409),
    ("Pulmonary hypertension", 4322024),
    ("Paralytic syndrome", 374377),
    ("Cirrhosis of liver", 4064161),
    ("Blood coagulation disorder", 432585),
    ("Restless legs", 73754),
    ("Urticaria", 139900),
    ("Contact dermatitis", 134438),
    ("Open-angle glaucoma", 441284),
    ("Psoriasis", 140168),
    ("Vasculitis", 4137275),
    ("Type 1 diabetes mellitus", 201254),
    ("Acute pancreatitis", 199074),
    ("Influenza", 4266367),
    ("Transient cerebral ischemia", 373503),
    ("Ascites", 200528),
    ("Diverticulitis of large intestine", 4260535),
    ("Opioid abuse", 438130),
    ("Systemic lupus erythematosus", 257628),
    ("Age related macular degeneration", 374028),
    ("Thyroiditis", 133444),
    ("Schizoaffective disorder", 4286201),
    ("Miscarriage", 4067106),
    ("Orthostatic hypotension", 319041),
    ("Dementia", 4182210),
    ("Hypoglycemia", 24609),
    ("Ventricular tachycardia", 4103295),
    ("Atopic dermatitis", 133834),
    ("Pulmonary edema", 4078925),
    ("Retinal detachment", 378414),
    ("Uveitis", 4028363),
    ("Endometriosis (clinical)", 433527),
    ("Sjogren's syndrome", 254443),
    ("Pancytopenia", 432881),
    ("Primary malignant neoplasm of respiratory tract", 4311499),
    ("Non-Hodgkin's lymphoma (clinical)", 4038838),
    ("Diabetic ketoacidosis", 443727),
    ("Neoplasm of thyroid gland", 4131909),
    ("Idiopathic peripheral neuropathy", 375806),
    ("Methicillin resistant Staphylococcus aureus infection", 440940),
    ("Monoclonal gammopathy (clinical)", 4002359),
    ("Photodermatitis", 4331304),
    ("Crohn's disease", 201606),
    ("Multiple sclerosis", 374919),
    ("Fracture of bone of hip region", 45763653),
    ("Gestational diabetes mellitus", 4024659),
    ("Type B viral hepatitis", 4281232),
    ("Hidradenitis", 434119),
    ("B-cell lymphoma (clinical)", 434592),
    ("Ulcerative colitis", 81893),
    ("Acute tubular necrosis", 444044),
    ("Facial palsy", 4091559),
    ("Malignant tumor of colon", 4180790),
    ("Intertrigo", 4242574),
    ("Primary malignant neoplasm of kidney", 198985),
    ("Hepatic failure", 4245975),
    ("Angioedema", 432791),
    ("Inflammatory bowel disease", 4074815),
    ("Systemic inflammatory response syndrome", 434821),
    ("Tuberculosis", 434557),
    ("Parkinson's disease", 381270),
    ("Malignant tumor of urinary bladder", 197508),
    ("Cardiac arrest", 321042),
    ("Malignant melanoma of skin", 141232),
    ("Malignant neoplasm of liver", 4246127),
    ("Psoriasis with arthropathy", 81931),
    ("Cerebral hemorrhage", 376713),
    ("Malignant neoplasm of anorectum", 40481902),
    ("Pre-eclampsia", 439393),
    ("Celiac disease", 194992),
    ("Optic neuritis", 374954),
    ("Sensory disorder of smell and/or taste", 43530714),
    ...
    ("Malignant tumor of ovary", 4181351),
    ("Alopecia areata", 141933),
    ("SLE glomerulonephritis syndrome", 4285717),
    ("Autoimmune hepatitis", 200762),
    ("Intellectual disability", 40277917),
    ("Ankylosing spondylitis", 437082),
    ("Cerebrovascular accident", 381316),
    ("Alzheimer's disease", 378419),
    ("Chronic lymphoid leukemia, disease", 138379),
    ("Pericarditis", 4138837),
    ("Acute arthritis", 4000634),
    ("Systemic sclerosis", 134442),
    ("Purpuric disorder", 4307580),
    ("Narcolepsy", 436100),
    ("Malignant tumor of cervix", 198984),
    ("Eosinophilic esophagitis", 27918),
    ("Autism spectrum disorder", 439776),
    ("Premature rupture of membranes", 194702),
    ("Amyloidosis", 432595),
    ("Myasthenia gravis", 76685),
    ("Temporal arteritis", 4290976),
    ("Malignant tumor of stomach", 443387),
